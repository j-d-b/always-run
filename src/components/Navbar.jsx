...
const NavLink = styled(Link)`
  ...
  color: #fff;
  padding: 0 1rem;
  background-color: ${props => props.to.substring(1) === window.location.pathname.split('/')[1] && props.theme.light};
...
// negate the navbar skew for text
...
export default function Navbar(props) {
  return (
    <NavbarBar height={props.height}>
      <NavbarLeft>
        <NavTitleBox>
          <NavText>
            <NavTitle>Always Run</NavTitle>
